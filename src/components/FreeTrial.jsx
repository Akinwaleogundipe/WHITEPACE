	...
	return (
		<>
			<main className="flex flex-col relative py-25 px-4 md:py-35 md:px-5 gap-20 container mx-auto">
				<img src="../assets/desktop/Group.png" alt="#" className="  " />
				...
				<div className="grid grid-flow-col auto-cols-max overflow-auto scroll-smooth gap-8 ">
					{testimonials.map((opt) => (
						<div key={opt?.name} className="max-w-[471.6px]">
							<div
								className={` py-14 px-10 rounded-lg flex flex-col justify-between gap-10 shadow-2xl bg-[${opt.bgcolor}] text-[${opt.textcolor}]`}
							>
								<div className="flex flex-col   border-b gap-2">
									...
									/>
									<p className=" font-[400] text-[18px]">{opt.description}</p>
								</div>
								...
								<div className="flex gap-6 items-center ">
									...
									<div className="flex flex-col gap-6">
										...
										<p className="font-[300] text-[16px]">{opt.position}</p>
									</div>
								</div>
							</div>
						</div>
