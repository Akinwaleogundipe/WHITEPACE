...
function Extension() {
	return (
		<div className="bg-[#043873]">
			<main className=" flex flex-col lg:flex-row gap-10 container mx-auto  text-center lg:text-start justify-center px-4 py-20 md:py-25 md:px-8  text-white">
				<div className="flex flex-col gap-15 ">
					<div className="">
						...
						<img
							src={underline}
							alt=""
							className="w-[177px] md:w-[326px] lg:w-[370px]  ml-auto -mt-4 md:mr-25 lg:mr-40 "
						/>
					</div>
