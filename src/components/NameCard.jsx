...
const Card = ({
	...
	return (
		<section
			className=" min-h-[458px] min-w-[288px]  py-15  px-10  rounded-[10px] flex flex-col justify-between gap-10 shadow-2xl "
		...
		>
			...
			<div className="flex gap-6 items-center ">
				...
				<div className="flex flex-col gap-6">
					<p className="text-2xl font-medium" style={{ color: namecolor }}>
						{name}
					</p>
