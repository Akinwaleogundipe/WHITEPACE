...
export default function Applications() {
    ...
    <>
      <main className=" flex flex-col   mx-auto  relative bg-[#043873] text-white">
        ...
        <section className="flex flex-col lg:flex-row   justify-center items-center text-center lg:text-start  z-10 gap-18 my-20 mx-4 md:mx-8 md:my-35">
          <div className=" ">
            <img src={Apps} alt="" className="  " />
          </div>
          <div className=" flex flex-col w-full lg:w-2/5  gap-8 ">
            ...
            <button className="bg-[#4F9CF9] self-center lg:self-start  w-fit px-16 py-7 rounded-[10px] flex place-content-center items-center text-xl gap-2 ">
